...
export default function FaqPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 pb-24">
      ...
      <nav
        aria-label="本頁目錄"
        className="mt-8 rounded-xl border border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-900/80 dark:bg-stone-900/80 px-4 py-4 text-sm"
      >
      ...
      <div className="mt-12 space-y-14 text-sm leading-relaxed text-stone-700 dark:text-stone-300">
        ...
        <section id="user-types" className="scroll-mt-24">
          ...
          <div className="mt-4 space-y-4">
            <div className="rounded-xl border border-stone-200 dark:border-stone-700 bg-surface px-4 py-3">
        ...
        <section id="social-bonus" className="scroll-mt-24">
          ...
          <div className="mt-8 space-y-8">
            ...
            <article className="rounded-xl border border-amber-200 bg-amber-50/50 px-4 py-4 dark:border-amber-800/50 dark:bg-amber-950/30">
