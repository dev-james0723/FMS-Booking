...
const OFFICIAL_SITE_URL = "https://d-festival.org";

function dFestivalElfsightClassFromEnv(): string | null {
  const raw =
...
export default function AboutDFestivalPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 pb-28 pt-8 sm:pt-10">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          <Image
            ...
            alt="歐顯星 — 聯合創辦人、科技與營運總監，D Festival"
            width={612}
            height={556}
          ...
          <p
            className="mt-2 font-serif text-3xl italic leading-none text-amber-900/85 sm:text-4xl"
            aria-label="Initials Au"
          >
            Au·
          </p>
      ...
      >
        ...
        <div
          className="mx-auto mt-10 max-w-3xl border-t border-white/20 px-4"
          role="separator"
          aria-hidden
        />
