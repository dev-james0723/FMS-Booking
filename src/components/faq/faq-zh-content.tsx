          ...
          <FaqVisualCardList
            items={[
              ...
              },
              {
                ...
                title: "提前預約日數（因類別而異）",
                tags: [
                  "教學／雙重身份：平日 14 日、週末 7 日",
                  "個人／老師推薦學生：平日 7 日、週末 3 日",
                ],
                blurb:
                  "系統會根據您的用戶類別，以及您所選時段屬平日或週末，自動決定可提前預約之日數。週末時段之提前預約日數較短，以確保高峰時段之公平使用。",
              },
              {
                variant: "sky",
                icon: "scale",
                ...
                tags: ["配額限制與提前日數分開計"],
                blurb:
                  "無論可提前預約之日數為何，於任何連續三個香港曆日內，預約節數之上限均維持不變（按用戶類別而定）。",
              },
            ]}
          />
        </section>
