export const coreZhHK = {
  ...
  home: {
    ...
    title: "限時免費琴室體驗預約",
    lead:
      "由 D Festival 青年鋼琴家藝術節與幻樂空間攜手推出，並由香港幻樂國際音樂管理公司贊助。{campaignRange}期間，限時免費開放予本地音樂工作者預約，用作練習、排練、試奏及錄影前綵排等音樂相關用途。首日（4 月 3 日）場地開放時間為 11:00–20:00，其餘活動日為 06:00–20:00（香港時間）。",
    registerCta: "登記資料及建立帳戶",
    loginCta: "預約系統登入",
    loginDisabledHint:
