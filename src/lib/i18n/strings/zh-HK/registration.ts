export const regZhHK = {
  ...
  socialFollow: "我承諾並願意追蹤指定社交媒體賬號，以參與試次琴室免費體驗活動。",
  socialRepost:
    "我承諾並願意轉發 D Festival 青年鋼琴藝術節的指定兩則貼文（限時動態或貼文），並標註（tag）D Festival 青年鋼琴家藝術節及幻樂空間的 Instagram 或 Facebook 賬號，以參與試次琴室免費體驗活動。",
